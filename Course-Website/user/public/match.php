...
<div class="page-wrapper">
	...
	<section class="popular-courses-section">
		<div class="auto-container">
			...
			<?php
				$selectquery = mysqli_query($db, "SELECT * FROM matches");
			...
			?>
				...
				<div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
					...
					<div class="image customsize">
							<a href="match-detail?matchid=<?php echo $rowselect['matchid']; ?>"><img src="../../course/<?php echo $rowselect['team_A_logo']; ?>"  alt="" /></a>
						</div>
						<div class="lower-content">
							<h5><a href="match-detail?matchid=<?php echo $rowselect['matchid']; ?>"><?php echo $rowselect['team_A_name']; ?> VS <?php echo $rowselect['team_B_name']; ?></a></h5>
							<h6><?php echo $rowselect['team_A_score']; ?>-<?php echo $rowselect['team_B_score']; ?></h6>
                            <div class="text"><?php echo $rowselect['status']; ?></div>
							<div class="clearfix">
							</div>
						</div>
					</div>
