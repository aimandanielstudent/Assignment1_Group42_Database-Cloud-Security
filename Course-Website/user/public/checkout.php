...
if(isset($_POST['submit'])){
  ...
  $selectquery = mysqli_query($db, "SELECT * FROM cart WHERE userid = '$check'");
  while($row = mysqli_fetch_array($selectquery)){
    $lessonid = $row['lessonid'];
    $class = $row['class'];
    $insertquery = mysqli_query($db, "INSERT INTO `enrolmen`(`userid`, `lessonid`, `class`) VALUES ('$check','$lessonid','$class')");
  }
  $deletequery = mysqli_query($db, "DELETE FROM cart WHERE userid = '$check'");
...
<head>
  ...
  <link rel="icon" href="<?php echo $websitefavicon; ?>" type="image/png" />
...
<div class="wrapper" id="app">
    <div class="card-form">
      ...
      <div class="card-form__inner">
        ...
        <button name="submit" class="card-form__button">
          Submit
        </button>
      </div>
  </form>
